...
export class HeaderComponent {
  ...
  trackClick(section: string) {
    logEvent(this.analytics, 'click_section', {
  ...
  navItems = signal<NavItem[]>([
    ...
    { label: 'Experience', href: '/experiencia', active: false },
    { label: 'Projects', href: '/proyectos', active: false },
  ]);
  ...
  socialLinks = signal<SocialLink[]>([
    ...
    },
    {
      ...
      url: 'https://www.linkedin.com/in/alaniz-aramayo-jos%C3%A9-john-856445384/',
      viewBox: '0 0 24 24',
    ...
    },
    {
      ...
      url: 'https://www.instagram.com/josejhon_al/',
